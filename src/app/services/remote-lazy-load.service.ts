/**
 * Here I am trying to modify the codes for the project to work in this 
 * scenario as an alternative dynamic module loader.
 * Origin: https://github.com/anyOpsOS/angularSystemJsRemoteLazyLoad
 * Work in progress
 */
...
export class RemoteLazyLoadService {
  source = `http://${window.location.host}/`;
  constructor() {
  }

  load(): any {
    console.log('starting SystemJsLoaderService::Constructor()');

    // Create a custom resolver
    // const originalResolve = window.System.resolve;
    // window.System.resolve = function(name: string): any {
    ...
    //     return `${this.source}/deps/${name}.umd.js`;
    ...
    //   }
    // };
    const url = this.source + 'assets/moduleb.umd.js';
